...
export class CanaryDepLambdaApigatewayStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props);
        ...
        // 3) Alarm on errors (sufficient for most cases)
        const errorAlarm = new cloudwatch.Alarm(this, "LambdaErrorsAlarm", {
          ...
          alarmDescription: "Alarm if the live alias sees any errors during canary.",
        });
    
        // 4) CodeDeploy Deployment Group for Canary Rollout
        ...
        // 5) API Gateway integrated with the Lambda Alias
